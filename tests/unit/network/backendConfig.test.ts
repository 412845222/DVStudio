...
describe('backendConfig', () => {
  ...
  describe('parseDwebProjectAssetUrl', () => {
    it('parses valid dweb:// URL', () => {
      const result = parseDwebProjectAssetUrl('dweb://project-assets?projectId=123&path=images%2Ftest.png')
    ...
    it('returns null for invalid projectId', () => {
      expect(parseDwebProjectAssetUrl('dweb://project-assets?projectId=abc&path=test.png')).toBeNull()
    })

    it('returns null for negative projectId', () => {
      expect(parseDwebProjectAssetUrl('dweb://project-assets?projectId=-1&path=test.png')).toBeNull()
    })
