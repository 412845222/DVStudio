...
describe('tree', () => {
	...
	describe('getLayerNodeTree', () => {
		it('returns node tree for existing layer', () => {
			const nodes: VideoSceneTreeNode[] = [
				{ id: 'node-1', name: 'Node 1', category: 'user' as any, children: [] }
			]
	...
	describe('walkTree', () => {
			...
			const nodes: VideoSceneTreeNode[] = [
				{
					...
					children: [{ id: '2', name: 'Child', category: 'user' as any, children: [] }]
				}
			]
		...
		it('passes correct parent and list to callback', () => {
			...
			const nodes: VideoSceneTreeNode[] = [
				{ id: '1', name: 'Root', category: 'user' as any, children: [childNode] }
			]
	...
	describe('nodeExistsInAnyLayer', () => {
		it('returns true if node exists', () => {
			const layer = createMockLayer([
				{ id: '1', name: 'Node', category: 'user' as any, children: [] }
			])
					...
					children: [
						{
							...
							name: 'Child',
							category: 'user' as any,
							children: [{ id: '3', name: 'Grandchild', category: 'user' as any, children: [] }]
						}
					]
				}
			]
	...
	describe('buildRenderPipeline', () => {
		...
		it('builds pipeline for multiple layers', () => {
			const layer1 = createMockLayer([
				{ id: '1', name: 'Node1', category: 'user' as any, userType: 'rect' as any, children: [] }
			])
			const layer2: VideoSceneLayer = {
				id: 'layer-2',
				name: 'Layer 2',
				nodeTree: [
					{ id: '2', name: 'Node2', category: 'user' as any, userType: 'text' as any, children: [] }
				]
			}
	...
	describe('findLayerIdByNodeIdInLayers', () => {
		it('finds layer containing node', () => {
			const layer1 = createMockLayer([
				{ id: '1', name: 'Node1', category: 'user' as any, children: [] }
			])
			const layer2: VideoSceneLayer = {
				id: 'layer-2',
				name: 'Layer 2',
