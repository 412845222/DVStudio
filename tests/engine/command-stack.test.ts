...
class TestCommand extends Command {
  ...
  constructor(type: string, executeFn: () => void = () => {}, undoFn: () => void = () => {}, mergeKey?: string) {
    super(type, mergeKey)
...
class MergeableCommand extends Command {
  ...
  constructor(mergeKey: string, value: number, executeFn: () => void = () => {}, undoFn: () => void = () => {}) {
...
describe('CommandStack', () => {
  ...
  describe('undo', () => {
    ...
    it('should undo commands in reverse order', () => {
      const order: string[] = []
      stack.execute(new TestCommand('a', () => order.push('exec-a'), () => order.push('undo-a')))
      stack.execute(new TestCommand('b', () => order.push('exec-b'), () => order.push('undo-b')))
  ...
  describe('undo/redo cycle', () => {
    it('should support multiple undo/redo cycles', () => {
      ...
      stack.redo()
      stack.redo()
      expect(states).toEqual(['initial', 'after-a', 'after-b', 'undo-b', 'undo-a', 'after-a', 'after-b'])
    })
  })
