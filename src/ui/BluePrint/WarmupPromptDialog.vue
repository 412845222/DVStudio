		...
		<div class="warmup-prompt-content">
			<div class="warmup-prompt-icon">
				<svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<path d="M14 48 L24 38 L32 44 L44 32 L52 40" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
					<circle cx="48" cy="20" r="4" fill="currentColor" opacity="0.3"/>
				</svg>
			</div>
			<div class="warmup-prompt-text">
				<p class="warmup-prompt-main">
					{{ t('aiworkflow.warmup.message', { count: warmupPromptState.unwarmedNodeIds.length, total: warmupPromptState.totalNodeCount }) }}
				</p>
...
import { warmupPromptState, useWarmupPrompt } from '../../views/AIWorkflow/node-screenshot/warmupPromptManager'
