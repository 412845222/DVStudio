    ...
    <div class="imd-dialog" role="dialog" aria-label="图片预览与标记">
      <div class="imd-toolbar">
        ...
        <div class="imd-toolbar-right">
          ...
          <button class="imd-btn" type="button" @click="resetTransform" title="重置为原始大小">重置</button>
          <button class="imd-btn" type="button" @click="fitToView" title="适应窗口">适应</button>
          <span class="imd-sep"></span>
          <button class="imd-btn" type="button" @click="rotateBy(-90)" title="向左旋转 90°">左旋</button>
          <button class="imd-btn" type="button" @click="rotateBy(90)" title="向右旋转 90°">右旋</button>
          <span class="imd-sep"></span>
          ...
          <span class="imd-sep"></span>
          <button class="imd-btn" type="button" @click="clearBrush" title="清除所有画笔标记">清除标记</button>
          <button
...
const emit = defineEmits<{
  ...
  (e: 'export-markup', payload: { file: File; dataUrl: string; width: number; height: number }): void
}>()
...
const onExportMarkup = () => {
  ...
  emit('export-markup', { file, dataUrl: result.dataUrl, width: result.width, height: result.height })
}
