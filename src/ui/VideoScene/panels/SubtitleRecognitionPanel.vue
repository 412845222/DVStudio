      ...
      <div v-if="hasResult" class="result-section">
        <div class="result-header">
          ...
          <div class="result-actions">
            ...
            <button class="vs-btn primary" @click="$emit('import-cues', cues)">导入到字幕编辑器</button>
          </div>
        </div>
        <div class="cue-list">
          <div v-for="(cue, i) in cues" :key="i" class="cue-item">
            <div class="cue-time">{{ formatTimeShort(cue.startTime) }} - {{ formatTimeShort(cue.endTime) }}</div>
