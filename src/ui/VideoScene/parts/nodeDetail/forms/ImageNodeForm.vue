		...
		<label class="vs-row">
			...
			<div class="vs-quick">
				<button
					class="vs-quick-btn"
					type="button"
					:class="{ active: draft.imageFit === 'contain' }"
					title="contain"
					@click="emit('set-fit', 'contain')"
				>
				...
				<button
					class="vs-quick-btn"
					type="button"
					:class="{ active: draft.imageFit === 'cover' }"
					title="cover"
					@click="emit('set-fit', 'cover')"
				>
					<svg viewBox="0 0 24 24" aria-hidden="true">
						<path d="M4 5h16v14H4V5zm2 2v10h12V7H6zm1 1h10v8H7V8z" />
					</svg>
				</button>
				<button
					class="vs-quick-btn"
					type="button"
					:class="{ active: draft.imageFit === 'fill' }"
					title="fill"
					@click="emit('set-fit', 'fill')"
				>
					<svg viewBox="0 0 24 24" aria-hidden="true">
				...
				<button
					class="vs-quick-btn"
					type="button"
					:class="{ active: draft.imageFit === 'none' }"
					title="none"
					@click="emit('set-fit', 'none')"
				>
					<svg viewBox="0 0 24 24" aria-hidden="true">
						<path d="M4 5h16v14H4V5zm7 5h2v4h-2v-4z" />
					</svg>
				</button>
				<button
					class="vs-quick-btn"
					type="button"
					:class="{ active: draft.imageFit === 'scale-down' }"
					title="scale-down"
					@click="emit('set-fit', 'scale-down')"
				>
					<svg viewBox="0 0 24 24" aria-hidden="true">
						<path d="M4 5h16v14H4V5zm2 2v10h12V7H6zm5 2h2v6h-2V9z" />
					</svg>
				</button>
			</div>
		</label>
