  ...
  <div v-if="visible" class="dvs-modal-overlay" :style="overlayStyle" @click.self="onBackdropClick">
    <div class="dvs-modal" :class="[`dvs-modal--${size}`]" role="dialog" aria-modal="true">
      <div v-if="showTitle" class="dvs-modal-head">
        ...
        <button v-if="showClose" class="dvs-modal-x" type="button" :aria-label="t('dialog.close')" @click="handleClose">
          ×
        </button>
      </div>
      ...
      <div v-if="showFooter" class="dvs-modal-actions">
        ...
        <button v-if="showCancel" class="btn" type="button" :disabled="disableCancel" @click="handleClose">
          {{ closeBtnText }}
        </button>
        <button v-if="showConfirm" class="btn" type="button" :disabled="disableConfirm" @click="handleConfirm">
          {{ confirmBtnText }}
        </button>
      </div>
    </div>
