<template>
  <div class="m3de-toolbar">
    ...
    <div class="m3de-toolbar-groups">
      ...
      <div class="m3de-toolbar-group">
        ...
        <label class="m3de-toolbar-checkbox">
          <input type="checkbox" :checked="shadowsEnabled" @change="$emit('update:shadowsEnabled', ($event.target as HTMLInputElement).checked)" />
          <span class="m3de-checkbox-indicator" />
          <span>{{ shadowsLabel }}</span>
        </label>
        <label class="m3de-toolbar-checkbox">
          <input type="checkbox" :checked="gridVisible" @change="$emit('update:gridVisible', ($event.target as HTMLInputElement).checked)" />
          <span class="m3de-checkbox-indicator" />
          <span>{{ gridLabel }}</span>
        </label>
        <label class="m3de-toolbar-checkbox">
          <input type="checkbox" :checked="axesVisible" @change="$emit('update:axesVisible', ($event.target as HTMLInputElement).checked)" />
          <span class="m3de-checkbox-indicator" />
          <span>{{ axesLabel }}</span>
        </label>
        <label class="m3de-toolbar-checkbox">
          <input type="checkbox" :checked="bloomEnabled" @change="$emit('update:bloomEnabled', ($event.target as HTMLInputElement).checked)" />
          <span class="m3de-checkbox-indicator" />
    ...
    <div class="m3de-toolbar-actions">
      <button class="m3de-toolbar-action-btn" @click="$emit('resetCamera')" :title="resetCameraLabel">
...
import type { RenderMode, LightingPreset, TransformMode } from '../../WorkFlow/WorlFlowNodes/model3d/editor/types'
