...
const currentMeta = computed(() => availableLocales.value.find((l) => l.code === locale.value) || availableLocales.value[0])
...
.lang-btn:focus {
  outline: none;
  box-shadow: 0 0 0 2px var(--theme-accent-muted, color-mix(in srgb, var(--theme-accent) 25%, transparent));
}
