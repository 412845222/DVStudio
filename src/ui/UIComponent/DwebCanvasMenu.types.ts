...
export type DwebCanvasMenuSpecialActionId =
  | 'upload'

export type DwebCanvasMenuActionId = DwebCanvasMenuNodeActionId | DwebCanvasMenuSpecialActionId

export type DwebCanvasMenuSource = 'pane-context' | 'connect-blank-drop' | 'selection-batch-io' | 'node-context'
...
export type DwebCanvasMenuDataKind = 'flow' | 'resource' | 'generic' | 'image' | 'video' | 'audio' | 'text'
