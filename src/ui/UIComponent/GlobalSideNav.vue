    ...
    >
      <span class="global-side-nav-icon" aria-hidden="true">
        <svg v-if="item.key === 'welcome'" viewBox="0 0 24 24" fill="none">
          <path d="M4 9.5L12 4l8 5.5" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M6.5 10.5V20h11V10.5" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M10 20v-4h4v4" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
        <svg v-else-if="item.key === 'workflow'" viewBox="0 0 24 24" fill="none">
          ...
          <path d="M8 7.2L10.6 16.8M16 7.2L13.4 16.8M8 6h8" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" />
        </svg>
        ...
        <svg v-else viewBox="0 0 24 24" fill="none">
          <path d="M12 3.5l2 1.2 2.3-.3.9 2.1 2.1.9-.3 2.3 1.2 2-1.2 2 .3 2.3-2.1.9-.9 2.1-2.3-.3-2 1.2-2-1.2-2.3.3-.9-2.1-2.1-.9.3-2.3-1.2-2 1.2-2-.3-2.3 2.1-.9.9-2.1 2.3.3 2-1.2z" stroke="currentColor" stroke-width="1.4" stroke-linejoin="round" />
...
.global-side-nav {
  ...
  padding: 10px 6px;
  overflow: hidden;
  transition: padding 220ms cubic-bezier(0.22, 0.61, 0.36, 1), background 220ms ease;
}
