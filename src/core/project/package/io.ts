...
const ensureManifestForSnapshotV1 = (
...
export const importProjectPackageV1String = (
	json: string,
	opt?: ImportProjectOptionsV1
): ImportProjectResultV1 => {
	...
	const rewritten = rewriteImageAssetIdsOnImportV1({
		snapshot: parsedSnapshot,
		manifest,
		existingImageAssetIds: existingIds
	})
	return {
