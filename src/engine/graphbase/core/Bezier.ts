...
export function bezierPoint(t: number, p0: Vector2, p1: Vector2, p2: Vector2, p3: Vector2): Vector2 {
  const u = 1 - t;
  const tt = t * t;
  const uu = u * u;
  const uuu = uu * u;
...
export function bezierTangent(t: number, p0: Vector2, p1: Vector2, p2: Vector2, p3: Vector2): Vector2 {
  const u = 1 - t;
  return new Vector2(
...
export function bezierLength(p0: Vector2, p1: Vector2, p2: Vector2, p3: Vector2, steps = 20): number {
  let length = 0;
  let prev = p0;
