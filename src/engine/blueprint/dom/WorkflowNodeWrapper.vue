...
.workflow-node-wrapper :deep(canvas),
.workflow-node-wrapper :deep(.wf-media-preview),
.workflow-node-wrapper :deep(.wf-media-video),
.workflow-node-wrapper :deep(.wf-media-poster-img),
.workflow-node-wrapper :deep(.wf-media-actions),
.workflow-node-wrapper :deep(.wf-media-footer),
.workflow-node-wrapper :deep(.wf-video-toolbar),
.workflow-node-wrapper :deep(.wf-video-row),
.workflow-node-wrapper :deep(.wf-video-controller),
.workflow-node-wrapper :deep(.vc-bar),
.workflow-node-wrapper :deep(.vc-timeline),
.workflow-node-wrapper :deep(.vc-volume),
.workflow-node-wrapper :deep(.wf-timeline-canvas),
.workflow-node-wrapper :deep(.wf-toolbar-btn),
