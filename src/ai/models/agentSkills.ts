...
export const BUILTIN_SKILLS: SkillDefinition[] = [
	{
		...
		prompt: '请先仔细分析当前场景，包括物体位置、光照设置、相机角度，然后再回答我的问题或执行操作。',
		icon: '🖼️',
		category: 'scene',
		order: 1
	},
	{
		...
		prompt: '专注于光照相关操作：调整环境光、方向光、点光源参数，优化阴影和反射效果。优先使用光照调整相关工具。',
		icon: '💡',
		category: 'scene',
		order: 2
	},
	{
		...
		prompt: '我需要创建新节点。请根据我的描述创建合适类型的节点，配置必要参数，并自动连接到合理的位置。',
		icon: '➕',
		category: 'node',
		order: 3
	},
	{
		...
		prompt: '请仔细查看我引用的节点配置，根据我的需求修改参数。修改前先说明要调整哪些参数，修改后确认变更。',
		icon: '⚙️',
		category: 'node',
		order: 4
	},
