...
export const dispatchDvsTimelineNav = (
	dir: -1 | 1,
	reason: DvsTimelineNavDetail['reason'] = 'program'
) => {
...
export const dispatchDvsEditorStateRestored = (
	reason: DvsEditorStateRestoredDetail['reason'] = 'replace'
) => {
