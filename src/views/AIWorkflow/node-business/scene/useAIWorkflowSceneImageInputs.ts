...
export const useAIWorkflowSceneImageInputs = (payload: {
  ...
  const connectedSceneDecomposeImageInputs = (nodeId: string) => connectedSceneUnderstandImageInputs(nodeId)

  const connectedSceneDecomposeImageInputRefs = (nodeId: string) => connectedSceneUnderstandImageInputRefs(nodeId)
  ...
  const connectedSceneDecomposeImageInputAt = (nodeId: string, sourceImageIndex: number) => {
    return payload.connectedImageInputSource(nodeId, sceneDecomposeImageInputAnchorId(sourceImageIndex))
  }
