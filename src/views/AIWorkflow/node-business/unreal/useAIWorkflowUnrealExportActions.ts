export const useAIWorkflowUnrealExportActions = (payload: {
	...
	const buildSlotsFromModelBindings = (
		...
		for (const binding of connectedModelBindings) {
			...
			finalSlots.push({
				...
				objectName: String(bindingObj.objectName ?? layoutItem?.name ?? objectId).trim() || objectId,
