...
export const routes = [
	...
	{
		channel: 'dweb:comfyui:setup:scan-foreign-comfy',
		handler: handlers.setupScanForeignComfyProcesses
	},
	{
		channel: 'dweb:comfyui:setup:kill-foreign-comfy',
		handler: handlers.setupKillForeignComfyProcesses
	},
	{
	...
	{
		channel: 'dweb:comfyui:setup:terminal:run-preset:stream',
		handler: handlers.setupTerminalRunPreset,
		stream: true
	},
	{
		channel: 'dweb:comfyui:setup:terminal:run-custom:stream',
		handler: handlers.setupTerminalRunCustom,
		stream: true
	},
	{ channel: 'dweb:comfyui:setup:terminal:check-mode', handler: handlers.setupTerminalCheckMode },
	// Launch args panel routes
	{
		channel: 'dweb:comfyui:setup:launch-args:core-tags',
		handler: handlers.setupLaunchArgsGetCoreTags
	},
	{
		channel: 'dweb:comfyui:setup:launch-args:reference-args',
		handler: handlers.setupLaunchArgsGetReferenceArgs
	},
	{
		channel: 'dweb:comfyui:setup:launch-args:get-current',
		handler: handlers.setupLaunchArgsGetCurrentText
	},
