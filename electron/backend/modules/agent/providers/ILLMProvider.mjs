...
export class ILLMProvider {
	 ...
	 */
	get id() {
		throw new Error('id must be implemented by subclass')
	}
	 ...
	 */
	get displayName() {
		throw new Error('displayName must be implemented by subclass')
	}
	...
	get supportsNativeToolCalls() {
		throw new Error('supportsNativeToolCalls must be implemented by subclass')
	}
	...
	async destroySession(sessionId) {
		throw new Error('destroySession must be implemented by subclass')
	}
}
