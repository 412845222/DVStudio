...
const TOOL_MODEL_PREFIXES = ['doubao-seed-', 'deepseek-v', 'deepseek-r', 'glm-', 'kimi-', 'qwen']

const THINKING_MODEL_PREFIXES = ['doubao-seed-evolving', 'doubao-seed-2-1-', 'doubao-seed-1-6-']
...
export class DVSAgentLLMClient {
	...
	async *streamChat(params) {
		...
		const canUseTools =
			tools.length > 0 && (this.apiSource !== 'bytedance' || modelSupportsTools(model))
