...
export const routes = [
	...
	{
		channel: 'dweb:subtitle-recog:download-binary:stream',
		handler: handlers.downloadBinary,
		stream: true
	},
	{ channel: 'dweb:subtitle-recog:get-ffmpeg-config', handler: handlers.getFfmpegConfig },
	{
		channel: 'dweb:subtitle-recog:download-ffmpeg:stream',
		handler: handlers.downloadFfmpeg,
		stream: true
	},
	...
	{
		channel: 'dweb:subtitle-recog:download-model:stream',
		handler: handlers.downloadModel,
		stream: true
	},
