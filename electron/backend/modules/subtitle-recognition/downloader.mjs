...
async function downloadWithRedirects(url, destPath, options = {}) {
  ...
  while (redirectCount < MAX_REDIRECTS) {
    if (onStatus) onStatus({ type: 'connecting', message: `正在连接 ${new URL(currentUrl).hostname}...` })
...
export async function* downloadFileStream(url, destPath, options = {}) {
  ...
  yield { type: 'progress', percent: 0, downloadedBytes: 0, totalBytes: 0, message: '连接中...', indeterminate: true }
