export const MIGRATION_CHECKLIST = {
    ...
    items: [
      {
        ...
        label: 'Codex会话管理',
        status: 'pending',
        ipcChannel: 'dweb:codex:sessions:*',
        djangoUrl: '/api/workflow/codex/*',
        notes: '需要Python: copilot-cli子进程管理',
        dependsOn: ['python-bridge'],
      },
      {
        key: 'codex-messages',
        label: 'Codex消息交互（流式）',
        status: 'pending',
        ipcChannel: 'dweb:codex:sessions:{id}:messages:stream',
        djangoUrl: null,
        dependsOn: ['python-bridge'],
      },
    ],
  ...
  'agent-skills': {
    ...
    items: [
      {
        key: 'agent-skills-list',
        label: '技能列表',
        status: 'pending',
        ipcChannel: 'dweb:agent-skills:list',
        djangoUrl: '/api/agent-skills/*',
        notes: '需要Python: Agent子进程',
        dependsOn: ['python-bridge'],
      },
      {
        key: 'agent-skills-execute',
        label: '执行技能（流式）',
        status: 'pending',
        ipcChannel: 'dweb:agent-skills:execute:stream',
        djangoUrl: null,
        dependsOn: ['python-bridge'],
      },
      {
