...
export const routes = [
	...
	{ channel: 'dweb:third-party:nanobanana:generate:stream', handler: handlers.nanobananaGenerateStream, stream: true },
	{ channel: 'dweb:third-party:seedream:generate:stream', handler: handlers.seedreamGenerateStream, stream: true },
	{ channel: 'dweb:third-party:gemini:image:generate:stream', handler: handlers.geminiImageGenerateStream, stream: true },
